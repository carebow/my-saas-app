# VPC Module for CareBow AWS-Native Architecture
# Creates a HIPAA-compliant VPC with public/private subnets and VPC endpoints
...
resource "aws_vpc" "main" {
  ...
  tags = {
    ...
    Purpose     = "CareBow HIPAA-compliant VPC"
  }
}
...
# VPC Endpoints for HIPAA compliance
